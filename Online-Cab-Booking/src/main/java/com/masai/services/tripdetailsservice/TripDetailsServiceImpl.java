...
//import com.masai.repository.CustomerRepository;
//import com.masai.repository.TripDetailsRepository;
//import com.masai.validation.TripDetailsHelper;
//
//@Service
//public class TripDetailsServiceImpl implements TripDetailsService {
//
...
//
//	@Autowired
//	private TripDetailsHelper tripDetailsHelper;
//
//	@Override
//	public ResponseEntity<TripDetails> insertTripDetails(TripDetailsDTO tripDto) {
//		Customer customer = tripDetailsHelper.validateCustomer(tripDto.getUsername(), tripDto.getPassword(), customerDao);
//
//		// Check if the customer has a trip already in progress
//		if (tripDetailsHelper.isTripInProgress(customer)) {
//			throw new TripInProgress("Cannot book another trip as a trip is already in progress");
//		}
//
//		// Assign an available driver
//		CabDriver cabDriver = tripDetailsHelper.findAvailableDriver(cabDriverDao);
//
//		// Create a new trip
//		TripDetails tripDetails = tripDetailsHelper.createTripDetails(customer, cabDriver, tripDto);
//
//		tripDetailsDao.save(tripDetails);
//
//		return new ResponseEntity<>(tripDetails, HttpStatus.ACCEPTED);
...
//		Customer customer = tripDetailsHelper.validateCustomer(tripDto.getUsername(), tripDto.getPassword(), customerDao);
//
//		String result = tripDetailsHelper.cancelActiveTrip(customer, cabDriverDao, customerDao);
...
//	@Override
//	public ResponseEntity<String> calculateBill(TripDetailsDTO tripDto) {
//		CabDriver cabDriver = tripDetailsHelper.validateDriver(tripDto.getUsername(), tripDto.getPassword(), cabDriverDao);
//
//		String bill = tripDetailsHelper.calculateTripBill(cabDriver);
...
//		Customer customer = tripDetailsHelper.validateCustomer(tripDto.getUsername(), tripDto.getPassword(), customerDao);
//
//		BillDetails billDetails = tripDetailsHelper.generateBillDetails(customer, tripDto.getTripId(), tripDetailsDao);
//		return new ResponseEntity<>(billDetails, HttpStatus.ACCEPTED);
//	}
//}
//
